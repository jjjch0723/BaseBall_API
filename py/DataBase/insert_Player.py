...
# JSON 파일을 로드하고 처리
file_paths = {
    'KBO_player_data': r'C:\DevTool\BaseBall\BaseBall_data_Crowling\json\player_info\all_kbo_players.json',
    'MLB_player_data': r'C:\DevTool\BaseBall\BaseBall_data_Crowling\json\player_info\all_mlb_players.json',
}
