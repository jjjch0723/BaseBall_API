...
def get_team_roster(team_id, team_name, league_name):
    # 40인 로스터를 가져오기 위해 rosterType을 '40Man'으로 설정
    roster = statsapi.roster(team_id, '40Man')
    print(roster)  # 로스터 데이터를 출력하여 구조 확인
    player_data = []
...
save_path = 'C:/DevTool/VS-WORKSPACE/json/all_mlb_players_ASDM.json'
