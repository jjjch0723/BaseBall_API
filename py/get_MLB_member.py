...
def get_player_info(player_id, team_id, team_name):
...
def get_team_roster(team_id, team_name):
    ...
    with ThreadPoolExecutor() as executor:
        futures = [executor.submit(get_player_info, player['person']['id'], team_id, team_name) for player in roster]
...
def get_all_players():
    ...
    with ThreadPoolExecutor() as executor:
        futures = [executor.submit(get_team_roster, team['id'], team['name']) for team in teams]
        for future in as_completed(futures):
